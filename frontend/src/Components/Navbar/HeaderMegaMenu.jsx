...
// --- MODIFICATION 1: Update navLinks array ---
const navLinks = [
  { to: '/', label: 'Home' },
  { to: '/search', label: 'Search Problems' }, // New link for the main feature
...
          {/* --- MODIFICATION 2: Update Logo Text --- */}
          <Text component={Link} to="/" className={classes.logo}>
            Problem Solver <Text component="span">AI</Text>
          </Text>
          {/* --------------------------------------- */}
